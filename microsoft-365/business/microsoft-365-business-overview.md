...
- הגדרת פריטי מדיניות מתקדמים ההופכים את הגישה ממיקומים לא מהימנים לזמינים או עוקפים אימות מרובה גורמים ממקומות מהימנים, כגון רשת המשרד (אימות מרובה גורמים תכלת כולל כתובות Ip אמינות וגישה מותנית). 
