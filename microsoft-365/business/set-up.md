...
---
# <a name="set-up-microsoft-365-business-premium-in-the-setup-wizard"></a>הגדרת הפרמיה העסקית של Microsoft 365 באשף ההתקנה

צפה בסרטון וידאו זה לקבלת סקירה כללית של מיקרוסופט 365 Business Premium התקנה.<br><br>
...
כאשר אתה רוכש מיקרוסופט 365 Business Premium, יש לך את האפשרות להשתמש בתחום שבבעלותך, או לקנות אחד במהלך [ההרשמה](sign-up.md).
...
כל משתמש שתוסיף באשף יוקצה באופן אוטומטי רשיון פרימיום של Microsoft 365 Business.

![צילום מסך של הדף ' הוספת משתמשים חדשים ' באשף](../media/addnewuserspage.png)

1. אם המנוי שלך ב-Microsoft 365 Business Premium כולל משתמשים קיימים (לדוגמה, אם השתמשת בתכלת AD Connect), תקבל אפשרות להקצות להם רשיונות כעת. קדימה, הוסף רשיונות גם להם.
...
1. אשף ההגדרה מזהה בדרך כלל את הרשם שלך, ומספק לך קישור להוראות מפורטות לעדכון רשומות ה- NS באתר האינטרנט של הרשם. אם לא, [שנה את שרתי הפנה להגדיר את Microsoft 365 עם כל רשם תחום](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/change-nameservers-at-any-domain-registrar). 
...
בניווט השמאלי, בחר **בהגדרה** ולאחר מכן, תחת **כניסה ואבטחה**, בחר **באבטחת מחשבי Windows 10**. בחר **' תצוגה '** כדי להתחיל. לקבלת הוראות מלאות, ראה [אבטחת מחשבי Windows 10](secure-win-10-pcs.md) .
...
כדי להתקין את Office ב-iOS נייד או התקנים אנדרואיד, ראה [הגדרת מכשירים ניידים עבור משתמשי מיקרוסופט עסקים Premium 365](set-up-mobile-devices.md).

באפשרותך גם להתקין את Office בנפרד. ראה [התקנת Office במחשב או במקינטוש](https://support.microsoft.com/office/4414eaaf-0478-48be-9c42-23adc4716658) לקבלת הוראות.
